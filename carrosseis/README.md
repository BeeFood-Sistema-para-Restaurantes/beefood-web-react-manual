...
| [`totem-autoatendimento/`](totem-autoatendimento/roteiro.md) | **Função** | [Totem de Autoatendimento](https://beefood.com.br/totem-de-autoatendimento/) — página sem conteúdo; o fato veio da tela | 4:5 | 8 | [`.zip`](totem-autoatendimento/entrega/totem-autoatendimento.zip) · [copy](totem-autoatendimento/copy-instagram.txt) |
