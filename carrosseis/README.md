...
| [`cardapio-digital-tablet/`](cardapio-digital-tablet/roteiro.md) | **Função** | [Cardápio Digital no Tablet](https://beefood.com.br/cardapio-digital-tablet/) — página inteira, servida pelo próprio site | 4:5 | 9 | [`.zip`](cardapio-digital-tablet/entrega/cardapio-digital-tablet.zip) · [copy](cardapio-digital-tablet/copy-instagram.txt) |
