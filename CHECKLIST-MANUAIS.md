...
Última atualização: 2026-08-04 (adicionado #11 Integração Uber Direct)
...
| 11 | **Integração Uber Direct** | Criar conta Uber + Uber Direct, cadastrar cartão e webhook, copiar credenciais (Customer ID/Client ID/Client Secret) em Desenvolvedor → Chaves de API e colar em Aplicativos → Entregas → Uber Direct | `manuais/integracao-uber-direct/` | ✅ Concluído | — |
