...
Última atualização: 2026-08-19 (#2 Fechar caixa concluído; escopo ajustado — a 2ª conferência virou o #12)
...
| 12 | **Segunda conferência (dupla checagem)** | Por que recontar, abrir a conferência de um caixa fechado (Ver Conferência), Adicionar 2ª Conferência, observações, marcar como conferido (cadeado) e resolver a quebra de caixa | `manuais/caixa-conferencia-2/` | ☑️ Aprovado | — |
