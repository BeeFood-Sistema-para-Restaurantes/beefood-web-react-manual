...
Última atualização: 2026-08-28 (**#58** Uai Rango; **#57** BeeFood Entregador; **#48** Capas e Destaques; **#49–#56** migrados do
...
| Ativar integração Uai Rango | `manuais/integracao-uai-rango/` | ✅ Concluído |
...
2. Se a sessão for da fila do ajuda.beefood, ler `PLANO-MIGRACAO-AJUDA.md`. A fila **#49–#56** já foi produzida. O **#57** (app Entregador) e o **#58** (Uai Rango) foram pedidos depois e também já estão prontos.
