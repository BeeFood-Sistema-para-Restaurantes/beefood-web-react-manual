...
annotate("01-lista.png", [
    (1, 0.355, 0.175, 0.520, 0.125),
    (2, 0.255, 0.230, 0.175, 0.175),
    (3, 0.430, 0.230, 0.620, 0.175),
])
annotate("02-dropdown-filtro.png", [
    (1, 0.255, 0.230, 0.175, 0.175),
    (2, 0.430, 0.230, 0.620, 0.175),
    (3, 0.430, 0.310, 0.620, 0.380),
])
annotate("03-passo1-mensagem.png", [
    (1, 0.620, 0.175, 0.900, 0.120),
    (2, 0.620, 0.330, 0.900, 0.250),
    (3, 0.620, 0.620, 0.900, 0.540),
    (4, 0.820, 0.900, 0.900, 0.820),
])
annotate("04-variacoes.png", [
    (1, 0.620, 0.580, 0.900, 0.500),
])
annotate("05-destinatarios.png", [
    (1, 0.780, 0.250, 0.900, 0.190),
    (2, 0.620, 0.300, 0.900, 0.250),
    (3, 0.620, 0.450, 0.900, 0.380),
], borrao=[(0.55, 0.40, 0.42, 0.42)])
annotate("06-resumo.png", [
    (1, 0.580, 0.280, 0.400, 0.220),
    (2, 0.750, 0.450, 0.900, 0.280),
    (3, 0.820, 0.900, 0.900, 0.820),
])
montar_celulares("07-whatsapp-campanha.png", [("w-campanha.png", "O cliente recebe")])
passthrough("07-whatsapp-campanha.png")
