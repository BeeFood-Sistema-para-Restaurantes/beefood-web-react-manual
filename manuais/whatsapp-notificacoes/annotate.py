...
annotate("01-lista.png", [
    ...
    (2, 0.245, 0.355, 0.175, 0.300),
    (3, 0.780, 0.355, 0.860, 0.300),
])
annotate("02-editar-pedido-feito.png", [
    (1, 0.620, 0.280, 0.900, 0.200),
    (2, 0.620, 0.520, 0.900, 0.450),
    (3, 0.780, 0.900, 0.900, 0.820),
])
annotate("03-editar-entregador.png", [
    (1, 0.580, 0.230, 0.880, 0.170),
    (2, 0.620, 0.380, 0.900, 0.300),
])
montar_celulares("04-whatsapp-notificacao.png", [("w-pedido-confirmado.png", "Pedido confirmado")])
passthrough("04-whatsapp-notificacao.png")
