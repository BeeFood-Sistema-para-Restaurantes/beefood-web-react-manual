...
for n in [
    "01-registro-br-dns.png","02-hostgator-alterar.png",
    "03-hostgator-outra-plataforma.png","04-hostgator-preencher-dns.png",
]:
    passthrough(n)

annotate("05-beefood-aplicativos.png", [
    (1, 0.085, 0.430, 0.200, 0.370),
    (2, 0.500, 0.480, 0.620, 0.540),
])
annotate("06-beefood-modal-dominio.png", [
    (1, 0.420, 0.760, 0.300, 0.680),
])
print("done")
