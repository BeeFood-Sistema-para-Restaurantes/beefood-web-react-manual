...
annotate("01-desconectado.png", [
    (1, 0.080, 0.205, 0.175, 0.155),
    (2, 0.825, 0.375, 0.825, 0.255),
])
annotate("02-qr-card.png", [
    (1, 0.860, 0.355, 0.860, 0.230),
    (2, 0.860, 0.430, 0.720, 0.500),
])
passthrough("03-qr-expandido.png")
