# texto-documentation.ia.md — #90 Conectar o WhatsApp (QR Code)
...
- A página sai **somente** do `whatsapp-conectar.md`
...
1. **Conteúdo do manual (use na íntegra):**
   `beefood-web-react-manual/manuais/whatsapp-conectar/whatsapp-conectar.md`

2. **Imagens (use estas 3, nesta ordem):**
   - `beefood-web-react-manual/manuais/whatsapp-conectar/imagens-tratadas/01-desconectado.png`
   - `beefood-web-react-manual/manuais/whatsapp-conectar/imagens-tratadas/02-qr-card.png`
   - `beefood-web-react-manual/manuais/whatsapp-conectar/imagens-tratadas/03-qr-expandido.png`

**NÃO leia** outros arquivos do projeto (ex.: `fluxo-codigo.md`, `MEMORIA*.md`, `annotate.py`, `imagens-puras/`).

**Como montar a página:**
- Use o conteúdo do `whatsapp-conectar.md` exatamente como está (seções, textos e tabelas).
...
| 1 | `01-desconectado.png` | setas | Conexão desconectada + Conectar |
| 2 | `02-qr-card.png` | setas | QR no card e Expandir |
| 3 | `03-qr-expandido.png` | contexto | QR grande com instrução do celular |
