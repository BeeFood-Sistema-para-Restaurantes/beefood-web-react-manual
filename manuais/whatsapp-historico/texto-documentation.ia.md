# texto-documentation.ia.md — #93 Histórico de mensagens do WhatsApp
...
1. **Conteúdo do manual (use na íntegra):**
   `beefood-web-react-manual/manuais/whatsapp-historico/whatsapp-historico.md`

2. **Imagens (use estas 1, nesta ordem):**
   - `beefood-web-react-manual/manuais/whatsapp-historico/imagens-tratadas/01-historico.png`

**NÃO leia** outros arquivos do projeto (ex.: `fluxo-codigo.md`, `MEMORIA*.md`, `annotate.py`, `imagens-puras/`).

**Como montar a página:**
- Use o conteúdo do `whatsapp-historico.md` exatamente como está (seções, textos e tabelas).
...
| 1 | `01-historico.png` | setas | Boletins pendentes |
