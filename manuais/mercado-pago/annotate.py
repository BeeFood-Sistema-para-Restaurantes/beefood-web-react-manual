...
for n in [
    "01-mp-criar-aplicativo.png","02-mp-preencher-app.png","03-mp-ativar-credenciais.png",
    "04-mp-formulario-industria.png","05-mp-credenciais-producao.png","06-mp-copiar-chaves.png",
]:
    passthrough(n)

annotate("07-beefood-aplicativos.png", [
    (1, 0.085, 0.430, 0.200, 0.370),
    (2, 0.380, 0.195, 0.500, 0.270),
])
annotate("09-beefood-modal-chaves.png", [
    (1, 0.500, 0.455, 0.330, 0.400),
    (2, 0.500, 0.545, 0.330, 0.600),
    (3, 0.360, 0.620, 0.260, 0.680),
    (4, 0.655, 0.720, 0.780, 0.770),
])
print("done")
