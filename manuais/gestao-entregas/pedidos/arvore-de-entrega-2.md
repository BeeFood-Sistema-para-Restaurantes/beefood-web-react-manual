...
São seis, e nenhuma depende de outra pessoa — não há janela combinada nesta rodada.

Três coisas para saber antes de começar, e as duas primeiras são travas:
...
**A pasta 28 precisa do APK de produção.** No build de desenvolvimento, "abrir sem rede" derruba o
app antes de qualquer tela, porque ele não carrega o bundle sem o Metro.
