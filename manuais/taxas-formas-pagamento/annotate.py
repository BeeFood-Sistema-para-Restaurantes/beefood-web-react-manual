...
annotate("02b-debito-bandeiras.png", [
    (1, 0.555, 0.425, 0.260, 0.360),
    (2, 0.555, 0.500, 0.260, 0.580),
    (3, 0.780, 0.905, 0.880, 0.820),
])
...
annotate("05-tabela-configurada.png", [
    (1, 0.720, 0.820, 0.500, 0.760),
    (2, 0.720, 0.880, 0.500, 0.940),
    (3, 0.720, 0.940, 0.280, 0.940),
])
annotate("06-pdv-pago.png", [
    (1, 0.625, 0.428, 0.490, 0.355),
    (2, 0.795, 0.426, 0.920, 0.350),
])
...
annotate("07b-detalhe-mastercard.png", [
    (1, 0.430, 0.560, 0.300, 0.500),
    (2, 0.580, 0.560, 0.710, 0.500),
    (3, 0.430, 0.645, 0.300, 0.730),
])
annotate("07c-detalhe-credito.png", [
    (1, 0.430, 0.560, 0.300, 0.500),
    (2, 0.580, 0.560, 0.710, 0.500),
    (3, 0.430, 0.645, 0.300, 0.730),
])
annotate("07d-detalhe-vale.png", [
    (1, 0.430, 0.560, 0.300, 0.500),
    (2, 0.580, 0.560, 0.710, 0.500),
    (3, 0.430, 0.645, 0.300, 0.730),
])
annotate("08-desemp-resumo.png", [
    (1, 0.185, 0.298, 0.290, 0.220),
    (2, 0.849, 0.408, 0.700, 0.300),
    (3, 0.927, 0.408, 0.960, 0.280),
    (4, 0.500, 0.530, 0.380, 0.640),
])
annotate("09-desemp-pagamentos.png", [
    (1, 0.900, 0.380, 0.450, 0.180),
    (2, 0.900, 0.580, 0.930, 0.450),
    (3, 0.900, 0.800, 0.450, 0.900),
])
print("done")
