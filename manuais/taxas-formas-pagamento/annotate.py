...
annotate("06-pdv-pago.png", [
    (1, 0.615, 0.490, 0.500, 0.420),
    (2, 0.782, 0.488, 0.900, 0.410),
])
...
annotate("08-desemp-recebimento.png", [
    ...
    (4, 0.500, 0.530, 0.360, 0.620),
])
annotate("09-desemp-dados.png", [
    (1, 0.360, 0.218, 0.240, 0.150),
    (2, 0.500, 0.268, 0.160, 0.210),
    (3, 0.520, 0.355, 0.160, 0.430),
])
print("done")
