...
annotate("08-desemp-recebimento.png", [
    ...
    (2, 0.760, 0.365, 0.620, 0.290),
    (3, 0.860, 0.365, 0.940, 0.290),
    (4, 0.620, 0.530, 0.400, 0.620),
])
annotate("09-desemp-dados.png", [
    (1, 0.345, 0.188, 0.230, 0.135),
    (2, 0.700, 0.355, 0.880, 0.310),
    (3, 0.700, 0.400, 0.880, 0.455),
    (4, 0.700, 0.445, 0.880, 0.530),
])
print("done")
