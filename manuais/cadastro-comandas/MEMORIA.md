...
|-----------------|-----------------|
| Cadastro individual | **Comanda 26** (código e descrição sugeridos) |
...
- **Dois ESC para sair dos modais de QR** (o modal do QR fica sobre o seletor de tipo).
...
| `11-codigo-barras.png` | 1 | Código de Barras |
...
- **30 comandas** cadastradas (códigos 1 a 30), todas ativas.
