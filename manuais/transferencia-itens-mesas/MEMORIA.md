...
> for mexer nele depois. O lojista lê só o `transferencia-itens-mesas.md` desta pasta.
> Se você é uma IA montando a página publicada, **pare de ler aqui**.

Manual **#97**. Produzido em 06/09/2026 (na PR original era #94; no merge com o fechamento fiscal passou a #97). Sandbox BeeFood3.
