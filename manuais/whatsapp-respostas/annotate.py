...
annotate("01-lista.png", [
    (1, 0.355, 0.205, 0.520, 0.155),
    (2, 0.780, 0.275, 0.880, 0.220),
    (3, 0.420, 0.335, 0.175, 0.300),
])
annotate("02-loja-fechada.png", [
    (1, 0.780, 0.230, 0.900, 0.170),
    (2, 0.620, 0.380, 0.900, 0.300),
    (3, 0.620, 0.620, 0.900, 0.540),
])
annotate("03-boas-vindas.png", [
    (1, 0.580, 0.200, 0.880, 0.145),
    (2, 0.780, 0.230, 0.900, 0.185),
    (3, 0.620, 0.360, 0.900, 0.280),
])
montar_celulares("04-whatsapp-respostas.png", [
    ("w-boas-vindas.png", "Boas-vindas"),
    ("w-loja-fechada.png", "Loja fechada"),
])
passthrough("04-whatsapp-respostas.png")
