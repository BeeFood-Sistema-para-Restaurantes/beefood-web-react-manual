...
for n in [
    "01-google-criar-conta.png","02-maps-primeiros-passos.png","03-maps-login-google.png",
    "04-faturamento-pais.png","05-faturamento-dados.png","06-faturamento-cartao.png",
    "07-faturamento-continuar.png","08-faturamento-confirmar.png","09-apis-necessarias.png",
    "10-chaves-cadastradas.png","11-criar-chave-api.png",
]:
    passthrough(n)

annotate("12-beefood-aplicativos.png", [
    (1, 0.085, 0.430, 0.200, 0.370),
    (2, 0.380, 0.420, 0.500, 0.500),
])
annotate("14-beefood-modal-chave.png", [
    (1, 0.500, 0.430, 0.330, 0.380),
    (2, 0.680, 0.700, 0.560, 0.760),
])
print("done")
