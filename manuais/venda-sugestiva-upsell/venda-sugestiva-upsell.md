...
![Menu de ações da tela Cardápio com a opção Venda Sugestiva (UpSell)](imagens-tratadas/01-menu-acoes.png)
...
![Janela Venda Sugestiva (UpSell) com a lista de produtos](imagens-tratadas/02-janela-geral.png)
...
![Janela de escolha ainda sem nenhum produto marcado](imagens-tratadas/03a-janela-vazia.png)
...
![Janela de escolha com quatro produtos marcados](imagens-tratadas/03-janela-escolha.png)
...
![Aviso de sucesso: venda sugestiva salva com 4 produtos](imagens-tratadas/03b-toast-salvo.png)
...
![Menu de três pontinhos do produto com a opção Venda Sugestiva](imagens-tratadas/04-menu-produto.png)
...
![Aba Venda Sugestiva dentro do cadastro do produto](imagens-tratadas/05-aba-cadastro.png)
...
![Limite de 6 produtos atingido](imagens-tratadas/06-limite.png)
...
![Sugestão no cardápio digital de delivery, do card até a sacola](imagens-tratadas/07-delivery.png)
...
![A mesma sugestão no cardápio digital presencial](imagens-tratadas/08-presencial.png)
...
![Mais Sugeridos por Valor e por Quantidade](imagens-tratadas/09-relatorio-delivery-listas.png)
...
![Relatório de Sugestões no canal Presencial](imagens-tratadas/10-relatorio-presencial.png)
