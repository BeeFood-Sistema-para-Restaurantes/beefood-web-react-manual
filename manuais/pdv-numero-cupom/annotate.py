"""Anota os screenshots do manual BeeFood - PDV numero e cupom (#44)."""
import os, math
...
annotate("02-numero-ligado.png", [
    (1, 0.812, 0.420, 0.900, 0.360),
    (2, 0.812, 0.500, 0.900, 0.580),
])
annotate("03-pdv-com-itens.png", [
    (1, 0.500, 0.700, 0.360, 0.600),
    (2, 0.860, 0.820, 0.920, 0.740),
    (3, 0.860, 0.900, 0.920, 0.960),
])
annotate("04-receber.png", [
    (1, 0.420, 0.160, 0.280, 0.080),
    (2, 0.500, 0.360, 0.280, 0.280),
    (3, 0.820, 0.140, 0.900, 0.080),
])
annotate("06-preview-cupom-html.png", [
    (1, 0.500, 0.060, 0.220, 0.040),
    (2, 0.500, 0.220, 0.720, 0.180),
    (3, 0.500, 0.620, 0.720, 0.700),
])
passthrough("01-card-pdv.png")
