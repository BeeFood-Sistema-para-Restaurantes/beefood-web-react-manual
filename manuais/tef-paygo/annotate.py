...
for n in [
    "01-pinpad.png","02-exemplo-pdc.png","03-paygo-chave.png","04-paygo-cnpj-pdc.png",
    "05-adm-configuracao.png","06-senha-tecnica.png","07-id-ponto-captura.png",
    "08-ip-servidor.png","09-adm-instalacao.png","10-senha-instalacao.png",
    "11-cnpj-cliente.png","12-instalacao-ok.png","13-erro-autenticacao.png","14-reset-acbr.png",
]:
    passthrough(n)

annotate("15-beefood-lista-tef.png", [
    (1, 0.355, 0.105, 0.355, 0.210),
])
print("done")
