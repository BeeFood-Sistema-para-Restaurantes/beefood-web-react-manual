...
- Mantenha em destaque: auto-save; Presencial ≠ Consumo no Local; os dois tipos de QR; o gerador da Configurações **não confere** o cadastro de mesas; Meus Links tem `presencial.beefood.com.br` e o cardápio de **visualização** (sem pedido).
...
| 7 | `07-meus-links-mesa.png` | setas | Link amarrado a uma mesa |
| 8 | `08-gerador-passo1.png` | setas | Mesas ou Comandas |
| 9 | `09-tipo-qr.png` | setas | Cardápio Digital × Código da Mesa |
| 10 | `10-cardapio-digital.png` | tira | Cardápio presencial no celular |
