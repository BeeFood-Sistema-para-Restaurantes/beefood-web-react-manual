"""Anota os screenshots do manual BeeFood - App Garcom (#40)."""
import os, math
...
annotate("01-card-taxa-mesas.png", [
    (1, 0.500, 0.220, 0.220, 0.140),
    (2, 0.500, 0.620, 0.220, 0.720),
])
annotate("03-menus-ligados.png", [
    (1, 0.812, 0.280, 0.900, 0.220),
    (2, 0.812, 0.360, 0.900, 0.320),
    (3, 0.812, 0.440, 0.900, 0.500),
    (4, 0.812, 0.520, 0.900, 0.600),
])
passthrough("02-bloco-app-garcom.png")
