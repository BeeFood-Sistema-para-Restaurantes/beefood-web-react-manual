# texto-documentation.ia.md — #92 Indicadores de WhatsApp e BeeBot
...
- A página sai **somente** do `whatsapp-indicadores.md`
...
1. **Conteúdo do manual (use na íntegra):**
   `beefood-web-react-manual/manuais/whatsapp-indicadores/whatsapp-indicadores.md`

2. **Imagens (use estas 1, nesta ordem):**
   - `beefood-web-react-manual/manuais/whatsapp-indicadores/imagens-tratadas/01-indicadores.png`

**NÃO leia** outros arquivos do projeto (ex.: `fluxo-codigo.md`, `MEMORIA*.md`, `annotate.py`, `imagens-puras/`).

**Como montar a página:**
- Use o conteúdo do `whatsapp-indicadores.md` exatamente como está (seções, textos e tabelas).
- Insira as 1 imagens na ordem acima, com as legendas da tabela no fim deste arquivo.
...
| 1 | `01-indicadores.png` | setas | Prévia vazia + canais |
