...
**Exemplo:** o marketplace manda **Pudim - Tradicional**, e no seu cardápio o produto se chama
...
| 2 | **1 item selecionado** | Confere se você marcou o que queria antes de clicar em qualquer botão. |
...
| Nº | Item | O que fazer |
|----|------|-------------|
| 1 | **Vincular: Pudim - Tradicional** | O nome que veio do marketplace. Confira antes de escolher o produto. |
...
É comum o mesmo produto chegar com nomes diferentes — cada marketplace escreve do seu jeito, e
...
Quando o item é do tipo **Grupo Opção**, a janela de escolha muda: além dos produtos, ela passa
...
![O produto criado no Cardápio](imagens-tratadas/10-cardapio-produto-criado.png)
...
Quando um pedido chega com item que ninguém vinculou ainda, o próprio pedido avisa. Abra o
...
Para ver todos os itens do pedido de uma vez, use o menu do próprio pedido: o botão **^** ao
...
Neste modo, o rodapé só oferece **Vincular**: criar produto e excluir são ações da lista geral.
...
> A trava olha apenas os **produtos** do pedido. Opção pendente não impede a emissão — mas
...
4. Vários nomes de fora podem apontar para **um** produto seu — selecione todos e vincule de uma vez.
...
Não. O pedido entra, é preparado e entregue normalmente. O vínculo é o que organiza cozinha,
...
**Vinculei no produto errado. Como corrijo?**
...
**Abri o vínculo de um pedido cancelado e a lista veio vazia.**
...
- **Ativação Aiqfome V2**, **Uai Rango** e as demais integrações de marketplace — como conectar
  a loja
