...
![Bandeiras de idioma no cadastro do setor](imagens-tratadas/01-setor-bandeiras.png)
...
![Nome do setor traduzido para o inglês](imagens-tratadas/02-setor-ingles.png)
...
![Nome e descrição do produto em inglês](imagens-tratadas/03-produto-ingles.png)
...
![Nome do complemento em inglês](imagens-tratadas/04-complemento-ingles.png)
...
![Nome do grupo de opções em inglês](imagens-tratadas/05-grupo-opcoes-ingles.png)
...
![Habilitar tradução na configuração do totem](imagens-tratadas/06-totem-idiomas.png)
