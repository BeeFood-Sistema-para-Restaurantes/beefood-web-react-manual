...
annotate("01-inbox.png", [
    (1, 0.080, 0.180, 0.175, 0.120),
    (2, 0.080, 0.270, 0.175, 0.220),
    (3, 0.080, 0.500, 0.175, 0.430),
])
annotate("02-switches.png", [
    (1, 0.180, 0.250, 0.620, 0.180),
    (2, 0.180, 0.360, 0.620, 0.290),
    (3, 0.180, 0.620, 0.620, 0.540),
])
montar_celulares("03-whatsapp-atendimento.png", [
    ("w-atendente.png", "Atendente humano"),
    ("w-pedido-assistido.png", "Pedido na conversa"),
])
passthrough("03-whatsapp-atendimento.png")
