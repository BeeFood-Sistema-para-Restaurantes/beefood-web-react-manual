...
- A página sai **somente** do `cadastro-mesas.md`
...
1. Conteúdo (use na íntegra):
   `beefood-web-react-manual/manuais/cadastro-mesas/cadastro-mesas.md`
...
8. Exemplo prático: montando um salão de 19 mesas
9. Resumo
...
| 2 | `02-tela-mesas.png` | com setas | A tela: Nova Mesa, busca, contador, Criar em Lote e Gerar QR Code |
...
| 12 | `13-qr-cardapio-presencial.png` | com setas | Faixa de mesas e os QR Codes do cardápio gerados |
