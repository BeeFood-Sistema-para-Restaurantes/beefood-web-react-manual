...
|------:|----------------------------------|------|---------|
| 1 | `01-historico.png` | setas | Histórico do período |
| 2 | `02-saldo-clientes.png` | setas | Busca pelo telefone fake |
| 3 | `03-detalhe-cliente.png` | setas | Extrato e botões de ajuste |
| 4 | `04-modal-ajuste.png` | setas | Adicionar saldo (motivo) |
