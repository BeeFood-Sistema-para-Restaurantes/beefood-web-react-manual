...
for n in [
    "01-meta-gerenciador-eventos.png","02-meta-conectar-fontes.png","03-meta-fonte-web.png",
    "04-meta-nome-pixel.png","05-meta-api-conversoes.png","06-meta-concluir.png",
    "07-meta-identificador.png","08-meta-gerar-token.png","09-meta-copiar-token.png",
]:
    passthrough(n)

annotate("10-beefood-aplicativos.png", [
    (1, 0.085, 0.430, 0.200, 0.370),
    (2, 0.265, 0.545, 0.400, 0.600),
])
annotate("11-beefood-pixel-lista.png", [
    (1, 0.780, 0.500, 0.880, 0.430),
])
annotate("12-beefood-modal-pixel.png", [
    (1, 0.500, 0.375, 0.330, 0.330),
    (2, 0.400, 0.445, 0.300, 0.500),
    (3, 0.655, 0.720, 0.780, 0.780),
])
print("done")
