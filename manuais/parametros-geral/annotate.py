"""Anota os screenshots do manual BeeFood - Parametros gerais (#42)."""
import os, math
...
annotate("01-card-geral.png", [
    (1, 0.812, 0.280, 0.900, 0.220),
    (2, 0.812, 0.400, 0.900, 0.460),
    (3, 0.780, 0.560, 0.900, 0.640),
])
annotate("02-motivo-ligado.png", [
    (1, 0.812, 0.280, 0.900, 0.220),
])
annotate("03-operador-ligado.png", [
    (1, 0.812, 0.400, 0.900, 0.340),
    (2, 0.780, 0.560, 0.900, 0.640),
])
annotate("04-testar-operador.png", [
    (1, 0.500, 0.320, 0.280, 0.220),
    (2, 0.500, 0.560, 0.720, 0.500),
    (3, 0.500, 0.820, 0.280, 0.880),
])
annotate("06-motivo-cancelar.png", [
    (1, 0.500, 0.300, 0.280, 0.200),
    (2, 0.500, 0.420, 0.720, 0.360),
    (3, 0.620, 0.580, 0.780, 0.660),
])
