"""Anota screenshots — #68 Exibir / Ocultar."""
import os, math
...
annotate("01-lista-exibir-ocultar.png", [
    (1, 0.072, 0.575, 0.165, 0.510),
    (2, 0.300, 0.105, 0.300, 0.175),
    (3, 0.420, 0.265, 0.280, 0.210),
])
...
annotate("03-modal-produtos.png", [
    (1, 0.260, 0.095, 0.140, 0.095),
    (2, 0.320, 0.300, 0.160, 0.230),
])

W, H, ph_h = montar_celulares("04-cardapio-digital.png", [
    ("04-cel-antes.png", "Antes — Brownie visível"),
    ("05-cel-depois.png", "Depois — oculto"),
])
