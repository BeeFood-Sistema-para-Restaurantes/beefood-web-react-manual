...
for n in [
    "01-atalho-autotef.png","02-shell-startup.png","03-copiar-atalho.png",
    "04-colar-inicializar.png","05-erro-a001.png",
]:
    passthrough(n)

annotate("06-beefood-lista-tef.png", [
    (1, 0.195, 0.105, 0.195, 0.210),
])
print("done")
