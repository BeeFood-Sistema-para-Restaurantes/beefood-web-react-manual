...
- Mantenha em destaque: o Pixel já está ligado (sem Pixel ID da Meta); a % do funil é sobre as **visitas**; contexto **Presencial** esconde **Iniciou pagamento**; rastreio desde **01/06/2026**.
...
| 7 | `08-segmentacao.png` | setas | Segmentação por origem |
| 8 | `07-como-funciona.png` | contexto | Modal Saiba como funciona |
