# texto-documentation.ia.md — #59 Entrega Fácil iFood
...
- A página sai **somente** do `entrega-facil-ifood.md`
...
Crie um novo manual no app: em **Aplicativos** (seção **Entrega**), adicione um manual chamado
**"Entrega Fácil iFood"**.
...
2. **Imagens (use estas 11, nesta ordem):**
   ...
   - `beefood-web-react-manual/manuais/entrega-facil-ifood/imagens-tratadas/03b-ifood-novo-cardapio.png`
...
|------:|----------------------------------|------|---------|
| 1 | `07-portal-ifood-entrega-sob-demanda.png` | contexto | Portal iFood — Entrega Sob Demanda |
| 2 | `08-portal-ifood-app-beefood.png` | contexto | BeeFood Ativo no portal de aplicativos |
| 3 | `03-modal-ifood-credenciais.png` | setas | Aplicativos → iFood → Credenciais |
