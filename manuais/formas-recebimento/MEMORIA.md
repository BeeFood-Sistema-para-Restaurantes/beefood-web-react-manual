...
| O que o cliente vê vem de **outra tela** | As duas listagens capturadas lado a lado (21 formas no cadastro × 18 no cardápio digital) |
...
Exemplo escolhido: **um vale novo com taxa e prazo**, que é o caso real de quem fecha com uma
...
- **O modal do cardápio digital é um painel lateral** (sheet à direita), não um diálogo
  centralizado — o recorte da imagem 10 pega só a faixa `x` de 0,635 a 1,0.
...
| `02-listagem.png` | 6 | A tela: é aqui que se liga o canal |
