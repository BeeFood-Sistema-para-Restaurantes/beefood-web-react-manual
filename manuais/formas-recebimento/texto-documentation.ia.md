...
- A página sai **somente** do `formas-recebimento.md`
...
1. Conteúdo (use na íntegra):
   `beefood-web-react-manual/manuais/formas-recebimento/formas-recebimento.md`
...
- pt-BR, didático. É um manual **de cadastro e de canais**: o leitor quer que a forma apareça no
  lugar certo. Mantenha o passo a passo e as tabelas "Nº → o que fazer" logo depois de cada imagem.
...
| 3 | `03-nova-forma.png` | com setas | O cadastro, aba **Configuração** |
